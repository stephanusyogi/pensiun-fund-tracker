            ...
            <div class="grid grid-cols-12 gap-6 mt-5">
                ...
                <div class="col-span-12 lg:col-span-4 2xl:col-span-3 flex lg:block flex-col-reverse">
                    ...
                    <div class="intro-y box p-5 bg-primary text-white mt-5">
                        ...
                        <div class="mt-4">
                        Return dan risiko pada PPIP merupakan estimasi jangka panjang dan sesuai dengan profile investasi DAPENBI IP yang mengacu strategic business plan DAPENBI IP.
                        </div>
                    </div>
                </div>
                <!-- END: Profile Menu -->
