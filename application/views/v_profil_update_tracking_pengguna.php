            ...
            <div class="grid grid-cols-12 gap-6 mt-5">
                ...
                <div class="col-span-12 lg:col-span-4 2xl:col-span-3 flex lg:block flex-col-reverse">
                    <div class="intro-y box mt-5 lg:mt-0">
                        ...
                        <div class="p-5 border-t border-slate-200/60 dark:border-darkmode-400">
                            ...
                            <a class="flex items-center mt-5 text-primary font-medium" href="<?= site_url() ?>profil/update-tracking-pengguna/1"> <i data-lucide="activity" class="w-4 h-4 mr-2"></i> Update Tracking Data </a>
                        </div>
                        <div class="p-5 border-t border-slate-200/60 dark:border-darkmode-400">
                ...
                <div class="col-span-12 lg:col-span-8 2xl:col-span-9">
                    <div class="grid grid-cols-12 gap-6">
                      ...
                      <div class="col-span-12 lg:col-span-4">
                          <label for="" class="form-label">Saldo Personal - Pasar Keuangan</label>
                          <input id="" type="text" class="form-control" placeholder="">
                      </div>
                      <div class="col-span-12 lg:col-span-4">
                          <label for="" class="form-label">Saldo Personal - Properti</label>
                          <input id="" type="text" class="form-control" placeholder="">
                      </div>
                      <div class="col-span-12 lg:col-span-4">
                          <label for="" class="form-label">Penambahan Saldo Tentative - PPIP</label>
                          <input id="" type="text" class="form-control" placeholder="">
                      </div>
                      <div class="col-span-12 lg:col-span-4">
