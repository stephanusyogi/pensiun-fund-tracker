                ...
                <div class="col-span-12 lg:col-span-4 2xl:col-span-3 flex lg:block flex-col-reverse">
                    <div class="intro-y box mt-5 lg:mt-0">
                        ...
                        <div class="p-5 border-t border-slate-200/60 dark:border-darkmode-400">
                            ...
                            <a class="flex items-center mt-5 text-primary font-medium" href="<?= base_url() ?>profil/setting-komposisi-investasi-lifeycle-fund/1"> <i data-lucide="settings" class="w-4 h-4 mr-2"></i> Setting Komposisi Investasi LifeCycle Fund </a>
                ...
                <div class="col-span-12 lg:col-span-8 2xl:col-span-9">
                    <div class="grid grid-cols-12 gap-6">
                      <div class="col-span-12 border-b">
                        <label for="" class="form-label">Pilih Setting Komposisi Investasi LifeCycle Fund</label>
                      ...
                      <div class="col-span-12">
                        <div class="overflow-x-auto">
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th class="whitespace-nowrap">Informasi Komposisi Investasi Terpilih</th>
                                        <th class="whitespace-nowrap">Tranche Investasi 1</th>
                                        <th class="whitespace-nowrap">Tranche Investasi 2</th>
                                        <th class="whitespace-nowrap">Tranche Likuiditas</th>
                                    </tr>
                                </thead>
                                <tbody>
                                  <tr>
                                  ...
                                  <tr>
                                    <td>Resiko Pasar Portofolio Personal</td>
                                    <td>13.21%</td>
                                    <td>12.05%</td>
                                    <td>0.13%</td>
                                  </tr>
                                  <tr>
                                    <td colspan="4">
                                      ...
                                      <p><span class="font-medium">Tranche Investasi 1:</span> Sebelum memasuki Tranche Investasi 2</p>
                                      <p><span class="font-medium">Tranche Investasi 2:</span> 5 tahun menjelang memasuki Tranche Likuiditas</p>
                                      <p><span class="font-medium">Tranche Likuiditas:</span> 2 tahun menjelang pensiun</p>
                                    </td>
                                  </tr>
                                </tbody>
                            </table>
